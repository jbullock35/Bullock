...
this package is that it offers you *less.* For example, the functions in this
...
asterisks or other symbols. This package makes easy things easy, and it makes
creating bad tables quite difficult.

This package makes tables easier to read by prioritizing the careful use of
white space between different table elements. It also produces "Tufte tables,"
in which standard errors are printed to the right of their estimates and in
smaller type. Relative to conventional formatting---which places standard
errors below the estimates and in parentheses---the formatting used here makes
it easier for readers to instantly identify the information that they need. To
my knowledge, the table design used here was first used in Edward Tufte's
essay on [The Cognitive Style of
...
they are produced by  `latexTable()`. This is easy to&nbsp;do, because
...
You may prefer not to generate standalone .tex or PDF files. Instead, you may
